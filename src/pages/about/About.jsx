...
const AboutPage = () => {
    ...
    return ( 
            <DefaultLayout>
               ...
               <h2>About Us</h2>
                    <p>Welcome to SHOPit Products, where we're passionate about providing our customers with the best shopping experience possible. Our company was founded on the principle of putting customers first, and we strive to maintain that philosophy every day.</p>
                    ...
                    <p>At Your SHOPit Products, we're more than just an e-commerce store. We're a community of like-minded individuals who share a passion for fashion and style. Our team is made up of dedicated professionals who are committed to making your shopping experience enjoyable and stress-free.</p>
                    ...
                    <p>Thank you for choosing SHOPit Products. We're confident that you'll love our products and our service, and we look forward to serving you for years to come.</p>
               </div>
               </div>
            </DefaultLayout>
     );
